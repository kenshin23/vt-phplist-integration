 ...
 * @package entity
 */
class VTigerPickListValuesSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerPickListValuesSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_picklistvalues_seq';
	const SQL_INSERT='INSERT INTO `vtiger_picklistvalues_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_picklistvalues_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_picklistvalues_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_picklistvalues_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_picklistvalues_seq` WHERE `id`=?';
	const FIELD_ID=-1425361102;
	 ...
	 *
	 * @param mixed $id
	 * @return VTigerPickListValuesSeq
	 */
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerPickListValuesSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerPickListValuesSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerPickListValuesSeq[]
	 */
	public static function findByExample(PDO $db,VTigerPickListValuesSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerPickListValuesSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerPickListValuesSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerPickListValuesSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerPickListValuesSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerPickListValuesSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_picklistvalues_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerPickListValuesSeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerPickListValuesSeq');
	}

	/**
	 * get single VTigerPickListValuesSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerPickListValuesSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerPickListValuesSeq') as $node) {
