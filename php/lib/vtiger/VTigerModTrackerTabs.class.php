 ...
 * @package entity
 */
class VTigerModTrackerTabs extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerModTrackerTabs';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_modtracker_tabs';
	const SQL_INSERT='INSERT INTO `vtiger_modtracker_tabs` (`tabid`,`visible`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_modtracker_tabs` (`tabid`,`visible`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_modtracker_tabs` SET `tabid`=?,`visible`=? WHERE `tabid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_modtracker_tabs` WHERE `tabid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_modtracker_tabs` WHERE `tabid`=?';
	const FIELD_TABID=-1862850253;
	const FIELD_VISIBLE=-1472956043;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerModTrackerTabs instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerModTrackerTabs $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerModTrackerTabs[]
	 */
	public static function findByExample(PDO $db,VTigerModTrackerTabs $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerModTrackerTabs instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_modtracker_tabs`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerModTrackerTabs instances
	 *
	...
	/**
	 * returns the result as an array of VTigerModTrackerTabs instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerModTrackerTabs[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerModTrackerTabs instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_modtracker_tabs`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerModTrackerTabs';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerModTrackerTabs');
	}

	/**
	 * get single VTigerModTrackerTabs instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerModTrackerTabs from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerModTrackerTabs') as $node) {
