 ...
 * @package entity
 */
class VTigerActivityCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerActivityCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_activitycf';
	const SQL_INSERT='INSERT INTO `vtiger_activitycf` (`activityid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_activitycf` (`activityid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_activitycf` SET `activityid`=? WHERE `activityid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_activitycf` WHERE `activityid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_activitycf` WHERE `activityid`=?';
	const FIELD_ACTIVITYID=748137072;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerActivityCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerActivityCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerActivityCf[]
	 */
	public static function findByExample(PDO $db,VTigerActivityCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerActivityCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_activitycf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerActivityCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerActivityCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerActivityCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerActivityCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_activitycf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerActivityCf');
	}

	/**
	 * get single VTigerActivityCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerActivityCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerActivityCf') as $node) {
