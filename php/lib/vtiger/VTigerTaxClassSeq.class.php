 ...
 * @package entity
 */
class VTigerTaxClassSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerTaxClassSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_taxclass_seq';
	const SQL_INSERT='INSERT INTO `vtiger_taxclass_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_taxclass_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_taxclass_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_taxclass_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_taxclass_seq` WHERE `id`=?';
	const FIELD_ID=-898732378;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerTaxClassSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerTaxClassSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerTaxClassSeq[]
	 */
	public static function findByExample(PDO $db,VTigerTaxClassSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerTaxClassSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_taxclass_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerTaxClassSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerTaxClassSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerTaxClassSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerTaxClassSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_taxclass_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerTaxClassSeq');
	}

	/**
	 * get single VTigerTaxClassSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerTaxClassSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerTaxClassSeq') as $node) {
