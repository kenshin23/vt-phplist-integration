 ...
 * @package entity
 */
class VTigerCurrenciesSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerCurrenciesSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_currencies_seq';
	const SQL_INSERT='INSERT INTO `vtiger_currencies_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_currencies_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_currencies_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_currencies_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_currencies_seq` WHERE `id`=?';
	const FIELD_ID=-1787510236;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerCurrenciesSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerCurrenciesSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerCurrenciesSeq[]
	 */
	public static function findByExample(PDO $db,VTigerCurrenciesSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerCurrenciesSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_currencies_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerCurrenciesSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerCurrenciesSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerCurrenciesSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerCurrenciesSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_currencies_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerCurrenciesSeq');
	}

	/**
	 * get single VTigerCurrenciesSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerCurrenciesSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerCurrenciesSeq') as $node) {
