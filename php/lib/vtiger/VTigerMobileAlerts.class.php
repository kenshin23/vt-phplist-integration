 ...
 * @package entity
 */
class VTigerMobileAlerts extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerMobileAlerts';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_mobile_alerts';
	const SQL_INSERT='INSERT INTO `vtiger_mobile_alerts` (`id`,`handler_path`,`handler_class`,`sequence`,`deleted`) VALUES (?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_mobile_alerts` (`handler_path`,`handler_class`,`sequence`,`deleted`) VALUES (?,?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_mobile_alerts` SET `id`=?,`handler_path`=?,`handler_class`=?,`sequence`=?,`deleted`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_mobile_alerts` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_mobile_alerts` WHERE `id`=?';
	const FIELD_ID=-1178931221;
	const FIELD_HANDLER_PATH=532832970;
	const FIELD_HANDLER_CLASS=-673742989;
	const FIELD_SEQUENCE=-1844838767;
	const FIELD_DELETED=-1323528375;
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_HANDLER_PATH=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,500,0,true),
		self::FIELD_HANDLER_CLASS=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,50,0,true),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerMobileAlerts instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerMobileAlerts $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerMobileAlerts[]
	 */
	public static function findByExample(PDO $db,VTigerMobileAlerts $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerMobileAlerts instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_mobile_alerts`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerMobileAlerts instances
	 *
	...
	/**
	 * returns the result as an array of VTigerMobileAlerts instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerMobileAlerts[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerMobileAlerts instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_mobile_alerts`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getId()) {
			...
			$stmt->bindValue(1,$this->getHandlerPath());
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerMobileAlerts');
	}

	/**
	 * get single VTigerMobileAlerts instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerMobileAlerts from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerMobileAlerts') as $node) {
