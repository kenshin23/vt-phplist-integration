 ...
 * @package entity
 */
class VTigerTicketsTatUsSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerTicketsTatUsSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_ticketstatus_seq';
	const SQL_INSERT='INSERT INTO `vtiger_ticketstatus_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_ticketstatus_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_ticketstatus_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_ticketstatus_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_ticketstatus_seq` WHERE `id`=?';
	const FIELD_ID=1199654709;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerTicketsTatUsSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerTicketsTatUsSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerTicketsTatUsSeq[]
	 */
	public static function findByExample(PDO $db,VTigerTicketsTatUsSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerTicketsTatUsSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_ticketstatus_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerTicketsTatUsSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerTicketsTatUsSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerTicketsTatUsSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerTicketsTatUsSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_ticketstatus_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerTicketsTatUsSeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerTicketsTatUsSeq');
	}

	/**
	 * get single VTigerTicketsTatUsSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerTicketsTatUsSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerTicketsTatUsSeq') as $node) {
