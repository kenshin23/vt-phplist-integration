 ...
 * @package entity
 */
class VTigerActivityProductRel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerActivityProductRel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_activityproductrel';
	const SQL_INSERT='INSERT INTO `vtiger_activityproductrel` (`activityid`,`productid`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_activityproductrel` (`activityid`,`productid`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_activityproductrel` SET `activityid`=?,`productid`=? WHERE `activityid`=? AND `productid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_activityproductrel` WHERE `activityid`=? AND `productid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_activityproductrel` WHERE `activityid`=? AND `productid`=?';
	const FIELD_ACTIVITYID=-948923351;
	const FIELD_PRODUCTID=-317240661;
	private static $PRIMARY_KEYS=array(self::FIELD_ACTIVITYID,self::FIELD_PRODUCTID);
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerActivityProductRel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerActivityProductRel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerActivityProductRel[]
	 */
	public static function findByExample(PDO $db,VTigerActivityProductRel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerActivityProductRel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_activityproductrel`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerActivityProductRel instances
	 *
	...
	/**
	 * returns the result as an array of VTigerActivityProductRel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerActivityProductRel[]
	 */
	public static function fromExecutedStatement(PDOStatement $stmt) {
		...
		while($result=$stmt->fetch(PDO::FETCH_ASSOC)) {
			$o=new VTigerActivityProductRel();
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerActivityProductRel instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_activityproductrel`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	 ...
	 * @return VTigerActivityProductRel
	 */
	public static function findById(PDO $db,$activityId,$productId) {
	...
	/**
	 * Fetch VTigerProducts which references this VTigerActivityProductRel. Will return null in case reference is invalid.
	 * `vtiger_activityproductrel`.`productid` -> `vtiger_products`.`productid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerActivityProductRel';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerActivityProductRel');
	}

	/**
	 * get single VTigerActivityProductRel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerActivityProductRel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerActivityProductRel') as $node) {
