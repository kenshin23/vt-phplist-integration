 ...
 * @package entity
 */
class VTigerProductCategorySeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerProductCategorySeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_productcategory_seq';
	const SQL_INSERT='INSERT INTO `vtiger_productcategory_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_productcategory_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_productcategory_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_productcategory_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_productcategory_seq` WHERE `id`=?';
	const FIELD_ID=-1648450158;
	 ...
	 *
	 * @param mixed $id
	 * @return VTigerProductCategorySeq
	 */
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerProductCategorySeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerProductCategorySeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerProductCategorySeq[]
	 */
	public static function findByExample(PDO $db,VTigerProductCategorySeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerProductCategorySeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerProductCategorySeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerProductCategorySeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerProductCategorySeq[]
	 */
	public static function fromExecutedStatement(PDOStatement $stmt) {
		...
		while($result=$stmt->fetch(PDO::FETCH_ASSOC)) {
			$o=new VTigerProductCategorySeq();
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerProductCategorySeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_productcategory_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerProductCategorySeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerProductCategorySeq');
	}

	/**
	 * get single VTigerProductCategorySeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerProductCategorySeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerProductCategorySeq') as $node) {
