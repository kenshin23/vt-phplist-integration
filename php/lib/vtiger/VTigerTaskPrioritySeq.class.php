 ...
 * @package entity
 */
class VTigerTaskPrioritySeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerTaskPrioritySeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_taskpriority_seq';
	const SQL_INSERT='INSERT INTO `vtiger_taskpriority_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_taskpriority_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_taskpriority_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_taskpriority_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_taskpriority_seq` WHERE `id`=?';
	const FIELD_ID=230045866;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerTaskPrioritySeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerTaskPrioritySeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerTaskPrioritySeq[]
	 */
	public static function findByExample(PDO $db,VTigerTaskPrioritySeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerTaskPrioritySeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_taskpriority_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerTaskPrioritySeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerTaskPrioritySeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerTaskPrioritySeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerTaskPrioritySeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_taskpriority_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerTaskPrioritySeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerTaskPrioritySeq');
	}

	/**
	 * get single VTigerTaskPrioritySeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerTaskPrioritySeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerTaskPrioritySeq') as $node) {
