 ...
 * @package entity
 */
class VTigerLeadsCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerLeadsCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_leadscf';
	const SQL_INSERT='INSERT INTO `vtiger_leadscf` (`leadid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_leadscf` (`leadid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_leadscf` SET `leadid`=? WHERE `leadid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_leadscf` WHERE `leadid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_leadscf` WHERE `leadid`=?';
	const FIELD_LEADID=21747617;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerLeadsCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerLeadsCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerLeadsCf[]
	 */
	public static function findByExample(PDO $db,VTigerLeadsCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerLeadsCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_leadscf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerLeadsCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerLeadsCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerLeadsCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerLeadsCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_leadscf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerLeadDetails which references this VTigerLeadsCf. Will return null in case reference is invalid.
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerLeadsCf');
	}

	/**
	 * get single VTigerLeadsCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerLeadsCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerLeadsCf') as $node) {
