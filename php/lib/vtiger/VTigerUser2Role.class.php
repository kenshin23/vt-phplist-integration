 ...
 * @package entity
 */
class VTigerUser2Role extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerUser2Role';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_user2role';
	const SQL_INSERT='INSERT INTO `vtiger_user2role` (`userid`,`roleid`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_user2role` (`userid`,`roleid`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_user2role` SET `userid`=?,`roleid`=? WHERE `userid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_user2role` WHERE `userid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_user2role` WHERE `userid`=?';
	const FIELD_USERID=2067640813;
	const FIELD_ROLEID=1978255320;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerUser2Role instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerUser2Role $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerUser2Role[]
	 */
	public static function findByExample(PDO $db,VTigerUser2Role $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerUser2Role instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerUser2Role instances
	 *
	...
	/**
	 * returns the result as an array of VTigerUser2Role instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerUser2Role[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerUser2Role instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_user2role`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerUsers which references this VTigerUser2Role. Will return null in case reference is invalid.
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerUser2Role');
	}

	/**
	 * get single VTigerUser2Role instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerUser2Role from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerUser2Role') as $node) {
