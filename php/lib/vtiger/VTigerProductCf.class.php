 ...
 * @package entity
 */
class VTigerProductCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerProductCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_productcf';
	const SQL_INSERT='INSERT INTO `vtiger_productcf` (`productid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_productcf` (`productid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_productcf` SET `productid`=? WHERE `productid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_productcf` WHERE `productid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_productcf` WHERE `productid`=?';
	const FIELD_PRODUCTID=-1518882376;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerProductCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerProductCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerProductCf[]
	 */
	public static function findByExample(PDO $db,VTigerProductCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerProductCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_productcf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerProductCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerProductCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerProductCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerProductCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_productcf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerProducts which references this VTigerProductCf. Will return null in case reference is invalid.
	 * `vtiger_productcf`.`productid` -> `vtiger_products`.`productid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerProductCf');
	}

	/**
	 * get single VTigerProductCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerProductCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerProductCf') as $node) {
