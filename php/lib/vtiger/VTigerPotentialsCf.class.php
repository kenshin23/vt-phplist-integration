 ...
 * @package entity
 */
class VTigerPotentialsCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerPotentialsCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_potentialscf';
	const SQL_INSERT='INSERT INTO `vtiger_potentialscf` (`potentialid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_potentialscf` (`potentialid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_potentialscf` SET `potentialid`=? WHERE `potentialid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_potentialscf` WHERE `potentialid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_potentialscf` WHERE `potentialid`=?';
	const FIELD_POTENTIALID=-1833011847;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerPotentialsCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerPotentialsCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerPotentialsCf[]
	 */
	public static function findByExample(PDO $db,VTigerPotentialsCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerPotentialsCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_potentialscf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerPotentialsCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerPotentialsCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerPotentialsCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerPotentialsCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_potentialscf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerPotential which references this VTigerPotentialsCf. Will return null in case reference is invalid.
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerPotentialsCf');
	}

	/**
	 * get single VTigerPotentialsCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerPotentialsCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerPotentialsCf') as $node) {
