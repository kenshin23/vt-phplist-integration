 ...
 * @package entity
 */
class VTigerInventoryTanDc extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerInventoryTanDc';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_inventory_tandc';
	const SQL_INSERT='INSERT INTO `vtiger_inventory_tandc` (`id`,`type`,`tandc`) VALUES (?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_inventory_tandc` (`id`,`type`,`tandc`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_inventory_tandc` SET `id`=?,`type`=?,`tandc`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_inventory_tandc` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_inventory_tandc` WHERE `id`=?';
	const FIELD_ID=-223253662;
	const FIELD_TYPE=201947073;
	const FIELD_TANDC=1964675129;
	private static $PRIMARY_KEYS=array(self::FIELD_ID);
	private static $AUTOINCREMENT_FIELDS=array();
	private static $FIELD_NAMES=array(
		self::FIELD_ID=>'id',
		self::FIELD_TYPE=>'type',
		self::FIELD_TANDC=>'tandc');
	...
	private static $PROPERTY_TYPES=array(
		...
		self::FIELD_TANDC=>Db2PhpEntity::PHP_TYPE_STRING);
	private static $FIELD_TYPES=array(
		self::FIELD_ID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_TYPE=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,30,0,false),
		self::FIELD_TANDC=>array(Db2PhpEntity::JDBC_TYPE_LONGVARCHAR,65535,0,true));
	private static $DEFAULT_VALUES=array(
		self::FIELD_ID=>0,
		self::FIELD_TYPE=>'',
		self::FIELD_TANDC=>null);
	private $id;
	private $type;
	private $tanDc;
	...
	public function &setTanDc($tanDc) {
		$this->notifyChanged(self::FIELD_TANDC,$this->tanDc,$tanDc);
		$this->tanDc=$tanDc;
		return $this;
	}
	...
	public function toArray() {
		return array(
			...
			self::FIELD_TANDC=>$this->getTanDc());
	}
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerInventoryTanDc instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerInventoryTanDc $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerInventoryTanDc[]
	 */
	public static function findByExample(PDO $db,VTigerInventoryTanDc $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerInventoryTanDc instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerInventoryTanDc instances
	 *
	...
	/**
	 * returns the result as an array of VTigerInventoryTanDc instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerInventoryTanDc[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerInventoryTanDc instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_inventory_tandc`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(3,$this->getTanDc());
	}
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerInventoryTanDc';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerInventoryTanDc');
	}

	/**
	 * get single VTigerInventoryTanDc instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerInventoryTanDc from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerInventoryTanDc') as $node) {
