 ...
 * @package entity
 */
class VTigerCustomAction extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerCustomAction';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_customaction';
	const SQL_INSERT='INSERT INTO `vtiger_customaction` (`cvid`,`subject`,`module`,`content`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_customaction` (`cvid`,`subject`,`module`,`content`) VALUES (?,?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_customaction` SET `cvid`=?,`subject`=?,`module`=?,`content`=? WHERE `cvid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_customaction` WHERE `cvid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_customaction` WHERE `cvid`=?';
	const FIELD_CVID=-50582337;
	const FIELD_SUBJECT=1915461531;
	const FIELD_MODULE=-1085287907;
	const FIELD_CONTENT=439910120;
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_SUBJECT=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,250,0,false),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerCustomAction instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerCustomAction $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerCustomAction[]
	 */
	public static function findByExample(PDO $db,VTigerCustomAction $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerCustomAction instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_customaction`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerCustomAction instances
	 *
	...
	/**
	 * returns the result as an array of VTigerCustomAction instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerCustomAction[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerCustomAction instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_customaction`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerCustomView which references this VTigerCustomAction. Will return null in case reference is invalid.
	 * `vtiger_customaction`.`cvid` -> `vtiger_customview`.`cvid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerCustomAction');
	}

	/**
	 * get single VTigerCustomAction instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerCustomAction from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerCustomAction') as $node) {
