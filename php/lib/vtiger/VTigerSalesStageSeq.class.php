 ...
 * @package entity
 */
class VTigerSalesStageSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerSalesStageSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_sales_stage_seq';
	const SQL_INSERT='INSERT INTO `vtiger_sales_stage_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_sales_stage_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_sales_stage_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_sales_stage_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_sales_stage_seq` WHERE `id`=?';
	const FIELD_ID=487991220;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerSalesStageSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerSalesStageSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerSalesStageSeq[]
	 */
	public static function findByExample(PDO $db,VTigerSalesStageSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerSalesStageSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_sales_stage_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerSalesStageSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerSalesStageSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerSalesStageSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerSalesStageSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_sales_stage_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerSalesStageSeq');
	}

	/**
	 * get single VTigerSalesStageSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerSalesStageSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerSalesStageSeq') as $node) {
