 ...
 * @package entity
 */
class VTigerSeProductsRel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerSeProductsRel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_seproductsrel';
	const SQL_INSERT='INSERT INTO `vtiger_seproductsrel` (`crmid`,`productid`,`setype`) VALUES (?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_seproductsrel` (`crmid`,`productid`,`setype`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_seproductsrel` SET `crmid`=?,`productid`=?,`setype`=? WHERE `crmid`=? AND `productid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_seproductsrel` WHERE `crmid`=? AND `productid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_seproductsrel` WHERE `crmid`=? AND `productid`=?';
	const FIELD_CRMID=1367750072;
	const FIELD_PRODUCTID=-43988727;
	const FIELD_SETYPE=-103135699;
	private static $PRIMARY_KEYS=array(self::FIELD_CRMID,self::FIELD_PRODUCTID);
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerSeProductsRel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerSeProductsRel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerSeProductsRel[]
	 */
	public static function findByExample(PDO $db,VTigerSeProductsRel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerSeProductsRel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_seproductsrel`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerSeProductsRel instances
	 *
	...
	/**
	 * returns the result as an array of VTigerSeProductsRel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerSeProductsRel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerSeProductsRel instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_seproductsrel`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	 ...
	 * @return VTigerSeProductsRel
	 */
	public static function findById(PDO $db,$crMid,$productId) {
	...
	/**
	 * Fetch VTigerProducts which references this VTigerSeProductsRel. Will return null in case reference is invalid.
	 * `vtiger_seproductsrel`.`productid` -> `vtiger_products`.`productid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerSeProductsRel');
	}

	/**
	 * get single VTigerSeProductsRel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerSeProductsRel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerSeProductsRel') as $node) {
