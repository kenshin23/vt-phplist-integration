 ...
 * @package entity
 */
class VTigerManufacturerSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerManufacturerSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_manufacturer_seq';
	const SQL_INSERT='INSERT INTO `vtiger_manufacturer_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_manufacturer_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_manufacturer_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_manufacturer_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_manufacturer_seq` WHERE `id`=?';
	const FIELD_ID=-2053062142;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerManufacturerSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerManufacturerSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerManufacturerSeq[]
	 */
	public static function findByExample(PDO $db,VTigerManufacturerSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerManufacturerSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_manufacturer_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerManufacturerSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerManufacturerSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerManufacturerSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerManufacturerSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_manufacturer_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerManufacturerSeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerManufacturerSeq');
	}

	/**
	 * get single VTigerManufacturerSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerManufacturerSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerManufacturerSeq') as $node) {
