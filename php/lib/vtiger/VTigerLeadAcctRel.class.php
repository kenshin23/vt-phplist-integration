 ...
 * @package entity
 */
class VTigerLeadAcctRel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerLeadAcctRel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_leadacctrel';
	const SQL_INSERT='INSERT INTO `vtiger_leadacctrel` (`leadid`,`accountid`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_leadacctrel` (`leadid`,`accountid`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_leadacctrel` SET `leadid`=?,`accountid`=? WHERE `leadid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_leadacctrel` WHERE `leadid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_leadacctrel` WHERE `leadid`=?';
	const FIELD_LEADID=225457425;
	const FIELD_ACCOUNTID=591229486;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerLeadAcctRel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerLeadAcctRel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerLeadAcctRel[]
	 */
	public static function findByExample(PDO $db,VTigerLeadAcctRel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerLeadAcctRel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_leadacctrel`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerLeadAcctRel instances
	 *
	...
	/**
	 * returns the result as an array of VTigerLeadAcctRel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerLeadAcctRel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerLeadAcctRel instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_leadacctrel`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerLeadDetails which references this VTigerLeadAcctRel. Will return null in case reference is invalid.
	 * `vtiger_leadacctrel`.`leadid` -> `vtiger_leaddetails`.`leadid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerLeadAcctRel');
	}

	/**
	 * get single VTigerLeadAcctRel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerLeadAcctRel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerLeadAcctRel') as $node) {
