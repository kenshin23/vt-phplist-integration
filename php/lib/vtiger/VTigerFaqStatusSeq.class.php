 ...
 * @package entity
 */
class VTigerFaqStatusSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerFaqStatusSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_faqstatus_seq';
	const SQL_INSERT='INSERT INTO `vtiger_faqstatus_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_faqstatus_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_faqstatus_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_faqstatus_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_faqstatus_seq` WHERE `id`=?';
	const FIELD_ID=1440209431;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerFaqStatusSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerFaqStatusSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerFaqStatusSeq[]
	 */
	public static function findByExample(PDO $db,VTigerFaqStatusSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerFaqStatusSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_faqstatus_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerFaqStatusSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerFaqStatusSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerFaqStatusSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerFaqStatusSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_faqstatus_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerFaqStatusSeq');
	}

	/**
	 * get single VTigerFaqStatusSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerFaqStatusSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerFaqStatusSeq') as $node) {
