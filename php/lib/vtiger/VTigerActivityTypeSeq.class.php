 ...
 * @package entity
 */
class VTigerActivityTypeSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerActivityTypeSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_activitytype_seq';
	const SQL_INSERT='INSERT INTO `vtiger_activitytype_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_activitytype_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_activitytype_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_activitytype_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_activitytype_seq` WHERE `id`=?';
	const FIELD_ID=-1755562998;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerActivityTypeSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerActivityTypeSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerActivityTypeSeq[]
	 */
	public static function findByExample(PDO $db,VTigerActivityTypeSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerActivityTypeSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_activitytype_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerActivityTypeSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerActivityTypeSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerActivityTypeSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerActivityTypeSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_activitytype_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerActivityTypeSeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerActivityTypeSeq');
	}

	/**
	 * get single VTigerActivityTypeSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerActivityTypeSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerActivityTypeSeq') as $node) {
