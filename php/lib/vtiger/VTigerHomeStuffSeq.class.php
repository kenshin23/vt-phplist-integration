 ...
 * @package entity
 */
class VTigerHomeStuffSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerHomeStuffSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_homestuff_seq';
	const SQL_INSERT='INSERT INTO `vtiger_homestuff_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_homestuff_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_homestuff_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_homestuff_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_homestuff_seq` WHERE `id`=?';
	const FIELD_ID=1937320842;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerHomeStuffSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerHomeStuffSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerHomeStuffSeq[]
	 */
	public static function findByExample(PDO $db,VTigerHomeStuffSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerHomeStuffSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_homestuff_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerHomeStuffSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerHomeStuffSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerHomeStuffSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerHomeStuffSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_homestuff_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerHomeStuffSeq');
	}

	/**
	 * get single VTigerHomeStuffSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerHomeStuffSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerHomeStuffSeq') as $node) {
