 ...
 * @package entity
 */
class VTigerWSapP extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerWSapP';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_wsapp';
	const SQL_INSERT='INSERT INTO `vtiger_wsapp` (`appid`,`name`,`appkey`,`type`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_wsapp` (`name`,`appkey`,`type`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_wsapp` SET `appid`=?,`name`=?,`appkey`=?,`type`=? WHERE `appid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_wsapp` WHERE `appid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_wsapp` WHERE `appid`=?';
	const FIELD_APPID=245061725;
	const FIELD_NAME=1393751306;
	const FIELD_APPKEY=-993019043;
	const FIELD_TYPE=1393953209;
	private static $PRIMARY_KEYS=array(self::FIELD_APPID);
	private static $AUTOINCREMENT_FIELDS=array(self::FIELD_APPID);
	private static $FIELD_NAMES=array(
		self::FIELD_APPID=>'appid',
		self::FIELD_NAME=>'name',
		self::FIELD_APPKEY=>'appkey',
	...
	public function &setAppKey($appKey) {
		$this->notifyChanged(self::FIELD_APPKEY,$this->appKey,$appKey);
		$this->appKey=$appKey;
		return $this;
	}

	/**
	 * get value for appkey 
	 *
	 * type:VARCHAR,size:255,default:null,nullable
	 *
	 * @return mixed
	...
	public function toArray() {
		return array(
			...
			self::FIELD_APPKEY=>$this->getAppKey(),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerWSapP instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerWSapP $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerWSapP[]
	 */
	public static function findByExample(PDO $db,VTigerWSapP $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerWSapP instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerWSapP instances
	 *
	...
	/**
	 * returns the result as an array of VTigerWSapP instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerWSapP[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerWSapP instances.
	 *
	 ...
	 * @return VTigerWSapP
	 */
	public static function findById(PDO $db,$appId) {
	...
	protected function bindValues(PDOStatement &$stmt) {
		$stmt->bindValue(1,$this->getAppId());
		$stmt->bindValue(2,$this->getName());
		$stmt->bindValue(3,$this->getAppKey());
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getAppId()) {
			...
			$stmt->bindValue(2,$this->getAppKey());
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerWSapP');
	}

	/**
	 * get single VTigerWSapP instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerWSapP from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerWSapP') as $node) {
