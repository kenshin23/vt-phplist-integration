 ...
 * @package entity
 */
class VTigerQuotesCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerQuotesCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_quotescf';
	const SQL_INSERT='INSERT INTO `vtiger_quotescf` (`quoteid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_quotescf` (`quoteid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_quotescf` SET `quoteid`=? WHERE `quoteid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_quotescf` WHERE `quoteid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_quotescf` WHERE `quoteid`=?';
	const FIELD_QUOTEID=256432697;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerQuotesCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerQuotesCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerQuotesCf[]
	 */
	public static function findByExample(PDO $db,VTigerQuotesCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerQuotesCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_quotescf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerQuotesCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerQuotesCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerQuotesCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerQuotesCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_quotescf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerQuotes which references this VTigerQuotesCf. Will return null in case reference is invalid.
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerQuotesCf');
	}

	/**
	 * get single VTigerQuotesCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerQuotesCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerQuotesCf') as $node) {
