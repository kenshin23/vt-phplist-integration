 ...
 * @package entity
 */
class VTigerManufacturer extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerManufacturer';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_manufacturer';
	const SQL_INSERT='INSERT INTO `vtiger_manufacturer` (`manufacturerid`,`manufacturer`,`presence`,`picklist_valueid`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_manufacturer` (`manufacturer`,`presence`,`picklist_valueid`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_manufacturer` SET `manufacturerid`=?,`manufacturer`=?,`presence`=?,`picklist_valueid`=? WHERE `manufacturerid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_manufacturer` WHERE `manufacturerid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_manufacturer` WHERE `manufacturerid`=?';
	const FIELD_MANUFACTURERID=1060947763;
	const FIELD_MANUFACTURER=-1563140072;
	const FIELD_PRESENCE=-1497557822;
	const FIELD_PICKLIST_VALUEID=-904530157;
	private static $PRIMARY_KEYS=array(self::FIELD_MANUFACTURERID);
	private static $AUTOINCREMENT_FIELDS=array(self::FIELD_MANUFACTURERID);
	private static $FIELD_NAMES=array(
		self::FIELD_MANUFACTURERID=>'manufacturerid',
	...
	private static $PROPERTY_TYPES=array(
		self::FIELD_MANUFACTURERID=>Db2PhpEntity::PHP_TYPE_INT,
	...
	private static $FIELD_TYPES=array(
		self::FIELD_MANUFACTURERID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_MANUFACTURER=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,200,0,false),
	...
	private static $DEFAULT_VALUES=array(
		self::FIELD_MANUFACTURERID=>null,
	...
	/**
	 * set value for manufacturerid 
	 *
	 * type:INT,size:10,default:null,primary,unique,autoincrement
	 *
	 * @param mixed $manufacturerId
	 * @return VTigerManufacturer
	 */
	public function &setManufacturerId($manufacturerId) {
		$this->notifyChanged(self::FIELD_MANUFACTURERID,$this->manufacturerId,$manufacturerId);
		$this->manufacturerId=$manufacturerId;
		return $this;
	}

	/**
	 * get value for manufacturerid 
	 *
	 * type:INT,size:10,default:null,primary,unique,autoincrement
	 *
	 * @return mixed
	...
	public function toArray() {
		return array(
			self::FIELD_MANUFACTURERID=>$this->getManufacturerId(),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerManufacturer instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerManufacturer $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerManufacturer[]
	 */
	public static function findByExample(PDO $db,VTigerManufacturer $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerManufacturer instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_manufacturer`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerManufacturer instances
	 *
	...
	/**
	 * returns the result as an array of VTigerManufacturer instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerManufacturer[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerManufacturer instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_manufacturer`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function assignByHash($result) {
		$this->setManufacturerId($result['manufacturerid']);
	 ...
	 * @return VTigerManufacturer
	 */
	public static function findById(PDO $db,$manufacturerId) {
		$stmt=self::prepareStatement($db,self::SQL_SELECT_PK);
		$stmt->bindValue(1,$manufacturerId);
		$affected=$stmt->execute();
		if (false===$affected) {
			$stmt->closeCursor();
			throw new Exception($stmt->errorCode() . ':' . var_export($stmt->errorInfo(), true), 0);
	...
	protected function bindValues(PDOStatement &$stmt) {
		$stmt->bindValue(1,$this->getManufacturerId());
		$stmt->bindValue(2,$this->getManufacturer());
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getManufacturerId()) {
			...
			$stmt->bindValue(1,$this->getManufacturer());
		...
		if (false!==$lastInsertId) {
			$this->setManufacturerId($lastInsertId);
		}
		$stmt->closeCursor();
		$this->notifyPristine();
		return $affected;
	...
	public function updateToDatabase(PDO $db) {
		...
		$this->bindValues($stmt);
		$stmt->bindValue(5,$this->getManufacturerId());
		$affected=$stmt->execute();
		if (false===$affected) {
			$stmt->closeCursor();
			throw new Exception($stmt->errorCode() . ':' . var_export($stmt->errorInfo(), true), 0);
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerManufacturer');
	}

	/**
	 * get single VTigerManufacturer instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerManufacturer from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerManufacturer') as $node) {
