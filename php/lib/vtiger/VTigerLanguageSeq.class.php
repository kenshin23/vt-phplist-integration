 ...
 * @package entity
 */
class VTigerLanguageSeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerLanguageSeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_language_seq';
	const SQL_INSERT='INSERT INTO `vtiger_language_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_language_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_language_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_language_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_language_seq` WHERE `id`=?';
	const FIELD_ID=1673531803;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerLanguageSeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerLanguageSeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerLanguageSeq[]
	 */
	public static function findByExample(PDO $db,VTigerLanguageSeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerLanguageSeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_language_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerLanguageSeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerLanguageSeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerLanguageSeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerLanguageSeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_language_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerLanguageSeq');
	}

	/**
	 * get single VTigerLanguageSeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerLanguageSeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerLanguageSeq') as $node) {
