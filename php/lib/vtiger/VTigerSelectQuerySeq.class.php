 ...
 * @package entity
 */
class VTigerSelectQuerySeq extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerSelectQuerySeq';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_selectquery_seq';
	const SQL_INSERT='INSERT INTO `vtiger_selectquery_seq` (`id`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_selectquery_seq` (`id`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_selectquery_seq` SET `id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_selectquery_seq` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_selectquery_seq` WHERE `id`=?';
	const FIELD_ID=-1513094829;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerSelectQuerySeq instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerSelectQuerySeq $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerSelectQuerySeq[]
	 */
	public static function findByExample(PDO $db,VTigerSelectQuerySeq $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerSelectQuerySeq instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_selectquery_seq`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerSelectQuerySeq instances
	 *
	...
	/**
	 * returns the result as an array of VTigerSelectQuerySeq instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerSelectQuerySeq[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerSelectQuerySeq instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_selectquery_seq`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerSelectQuerySeq';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerSelectQuerySeq');
	}

	/**
	 * get single VTigerSelectQuerySeq instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerSelectQuerySeq from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerSelectQuerySeq') as $node) {
