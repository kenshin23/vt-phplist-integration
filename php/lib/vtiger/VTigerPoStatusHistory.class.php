 ...
 * @package entity
 */
class VTigerPoStatusHistory extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerPoStatusHistory';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_postatushistory';
	const SQL_INSERT='INSERT INTO `vtiger_postatushistory` (`historyid`,`purchaseorderid`,`vendorname`,`total`,`postatus`,`lastmodified`) VALUES (?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_postatushistory` (`purchaseorderid`,`vendorname`,`total`,`postatus`,`lastmodified`) VALUES (?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_postatushistory` SET `historyid`=?,`purchaseorderid`=?,`vendorname`=?,`total`=?,`postatus`=?,`lastmodified`=? WHERE `historyid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_postatushistory` WHERE `historyid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_postatushistory` WHERE `historyid`=?';
	const FIELD_HISTORYID=1279056526;
	const FIELD_PURCHASEORDERID=859118439;
	const FIELD_VENDORNAME=-259900972;
	const FIELD_TOTAL=-2046140253;
	const FIELD_POSTATUS=-781013774;
	const FIELD_LASTMODIFIED=-1024057056;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerPoStatusHistory instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerPoStatusHistory $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerPoStatusHistory[]
	 */
	public static function findByExample(PDO $db,VTigerPoStatusHistory $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerPoStatusHistory instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_postatushistory`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerPoStatusHistory instances
	 *
	...
	/**
	 * returns the result as an array of VTigerPoStatusHistory instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerPoStatusHistory[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerPoStatusHistory instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_postatushistory`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(2,$this->getPurchaseOrderId());
		$stmt->bindValue(3,$this->getVendorName());
		$stmt->bindValue(4,$this->getTotal());
		$stmt->bindValue(5,$this->getPoStatus());
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getHistoryId()) {
			...
			$stmt->bindValue(2,$this->getVendorName());
			$stmt->bindValue(3,$this->getTotal());
			$stmt->bindValue(4,$this->getPoStatus());
	...
	/**
	 * Fetch VTigerPurchaseOrder which references this VTigerPoStatusHistory. Will return null in case reference is invalid.
	 * `vtiger_postatushistory`.`purchaseorderid` -> `vtiger_purchaseorder`.`purchaseorderid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public function fetchVTigerPurchaseOrder(PDO $db, $sort=null) {
		$filter=array(VTigerPurchaseOrder::FIELD_PURCHASEORDERID=>$this->getPurchaseOrderId());
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerPoStatusHistory';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerPoStatusHistory');
	}

	/**
	 * get single VTigerPoStatusHistory instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerPoStatusHistory from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerPoStatusHistory') as $node) {
