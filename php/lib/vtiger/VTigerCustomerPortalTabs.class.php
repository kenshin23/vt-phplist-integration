 ...
 * @package entity
 */
class VTigerCustomerPortalTabs extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerCustomerPortalTabs';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_customerportal_tabs';
	const SQL_INSERT='INSERT INTO `vtiger_customerportal_tabs` (`tabid`,`visible`,`sequence`) VALUES (?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_customerportal_tabs` (`tabid`,`visible`,`sequence`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_customerportal_tabs` SET `tabid`=?,`visible`=?,`sequence`=? WHERE `tabid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_customerportal_tabs` WHERE `tabid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_customerportal_tabs` WHERE `tabid`=?';
	const FIELD_TABID=-978057249;
	const FIELD_VISIBLE=-1590403807;
	const FIELD_SEQUENCE=2002493682;
	 ...
	 *
	 * @param mixed $tabId
	 * @return VTigerCustomerPortalTabs
	 */
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerCustomerPortalTabs instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerCustomerPortalTabs $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerCustomerPortalTabs[]
	 */
	public static function findByExample(PDO $db,VTigerCustomerPortalTabs $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerCustomerPortalTabs instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_customerportal_tabs`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerCustomerPortalTabs instances
	 *
	...
	/**
	 * returns the result as an array of VTigerCustomerPortalTabs instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerCustomerPortalTabs[]
	 */
	public static function fromExecutedStatement(PDOStatement $stmt) {
		...
		while($result=$stmt->fetch(PDO::FETCH_ASSOC)) {
			$o=new VTigerCustomerPortalTabs();
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerCustomerPortalTabs instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_customerportal_tabs`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(2,$this->getVisible());
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerCustomerPortalTabs';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerCustomerPortalTabs');
	}

	/**
	 * get single VTigerCustomerPortalTabs instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerCustomerPortalTabs from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerCustomerPortalTabs') as $node) {
