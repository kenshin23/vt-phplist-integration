 ...
 * @package entity
 */
class VTigerAccountsCf extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerAccountsCf';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_accountscf';
	const SQL_INSERT='INSERT INTO `vtiger_accountscf` (`accountid`) VALUES (?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_accountscf` (`accountid`) VALUES (?)';
	const SQL_UPDATE='UPDATE `vtiger_accountscf` SET `accountid`=? WHERE `accountid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_accountscf` WHERE `accountid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_accountscf` WHERE `accountid`=?';
	const FIELD_ACCOUNTID=-102992999;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerAccountsCf instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerAccountsCf $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerAccountsCf[]
	 */
	public static function findByExample(PDO $db,VTigerAccountsCf $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerAccountsCf instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_accountscf`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerAccountsCf instances
	 *
	...
	/**
	 * returns the result as an array of VTigerAccountsCf instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerAccountsCf[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerAccountsCf instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_accountscf`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	/**
	 * Fetch VTigerAccount which references this VTigerAccountsCf. Will return null in case reference is invalid.
	...
	public function fetchVTigerAccount(PDO $db, $sort=null) {
		$filter=array(VTigerAccount::FIELD_ACCOUNTID=>$this->getAccountId());
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerAccountsCf');
	}

	/**
	 * get single VTigerAccountsCf instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerAccountsCf from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerAccountsCf') as $node) {
