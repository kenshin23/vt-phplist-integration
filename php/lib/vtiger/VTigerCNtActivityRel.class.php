 ...
 * @package entity
 */
class VTigerCNtActivityRel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerCNtActivityRel';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_cntactivityrel';
	const SQL_INSERT='INSERT INTO `vtiger_cntactivityrel` (`contactid`,`activityid`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_cntactivityrel` (`contactid`,`activityid`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_cntactivityrel` SET `contactid`=?,`activityid`=? WHERE `contactid`=? AND `activityid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_cntactivityrel` WHERE `contactid`=? AND `activityid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_cntactivityrel` WHERE `contactid`=? AND `activityid`=?';
	const FIELD_CONTACTID=-1020532956;
	const FIELD_ACTIVITYID=336983969;
	private static $PRIMARY_KEYS=array(self::FIELD_CONTACTID,self::FIELD_ACTIVITYID);
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerCNtActivityRel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerCNtActivityRel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerCNtActivityRel[]
	 */
	public static function findByExample(PDO $db,VTigerCNtActivityRel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerCNtActivityRel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_cntactivityrel`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerCNtActivityRel instances
	 *
	...
	/**
	 * returns the result as an array of VTigerCNtActivityRel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerCNtActivityRel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerCNtActivityRel instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_cntactivityrel`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	 ...
	 * @return VTigerCNtActivityRel
	 */
	public static function findById(PDO $db,$contactId,$activityId) {
	...
	public function updateToDatabase(PDO $db) {
		...
		$this->bindValues($stmt);
		$stmt->bindValue(3,$this->getContactId());
	...
	/**
	 * Fetch VTigerContactDetails which references this VTigerCNtActivityRel. Will return null in case reference is invalid.
	 * `vtiger_cntactivityrel`.`contactid` -> `vtiger_contactdetails`.`contactid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerCNtActivityRel';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerCNtActivityRel');
	}

	/**
	 * get single VTigerCNtActivityRel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerCNtActivityRel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerCNtActivityRel') as $node) {
