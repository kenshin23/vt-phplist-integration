 ...
 * @package entity
 */
class VTigerServiceUsageUnit extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerServiceUsageUnit';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_service_usageunit';
	const SQL_INSERT='INSERT INTO `vtiger_service_usageunit` (`service_usageunitid`,`service_usageunit`,`presence`,`picklist_valueid`) VALUES (?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_service_usageunit` (`service_usageunit`,`presence`,`picklist_valueid`) VALUES (?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_service_usageunit` SET `service_usageunitid`=?,`service_usageunit`=?,`presence`=?,`picklist_valueid`=? WHERE `service_usageunitid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_service_usageunit` WHERE `service_usageunitid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_service_usageunit` WHERE `service_usageunitid`=?';
	const FIELD_SERVICE_USAGEUNITID=1930189165;
	const FIELD_SERVICE_USAGEUNIT=-1812514606;
	const FIELD_PRESENCE=-1043768348;
	const FIELD_PICKLIST_VALUEID=-989725643;
	private static $PRIMARY_KEYS=array(self::FIELD_SERVICE_USAGEUNITID);
	private static $AUTOINCREMENT_FIELDS=array(self::FIELD_SERVICE_USAGEUNITID);
	private static $FIELD_NAMES=array(
		self::FIELD_SERVICE_USAGEUNITID=>'service_usageunitid',
	...
	private static $PROPERTY_NAMES=array(
		self::FIELD_SERVICE_USAGEUNITID=>'serviceUsageUnitId',
		self::FIELD_SERVICE_USAGEUNIT=>'serviceUsageUnit',
		self::FIELD_PRESENCE=>'presence',
		self::FIELD_PICKLIST_VALUEID=>'pickListValueId');
	private static $PROPERTY_TYPES=array(
		self::FIELD_SERVICE_USAGEUNITID=>Db2PhpEntity::PHP_TYPE_INT,
	...
	private static $FIELD_TYPES=array(
		self::FIELD_SERVICE_USAGEUNITID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_SERVICE_USAGEUNIT=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,200,0,false),
	...
	private static $DEFAULT_VALUES=array(
		self::FIELD_SERVICE_USAGEUNITID=>null,
		self::FIELD_SERVICE_USAGEUNIT=>'',
		self::FIELD_PRESENCE=>1,
		self::FIELD_PICKLIST_VALUEID=>0);
	private $serviceUsageUnitId;
	private $serviceUsageUnit;
	private $presence;
	private $pickListValueId;

	/**
	 * set value for service_usageunitid 
	 *
	 * type:INT,size:10,default:null,primary,unique,autoincrement
	 *
	 * @param mixed $serviceUsageUnitId
	 * @return VTigerServiceUsageUnit
	 */
	public function &setServiceUsageUnitId($serviceUsageUnitId) {
		$this->notifyChanged(self::FIELD_SERVICE_USAGEUNITID,$this->serviceUsageUnitId,$serviceUsageUnitId);
		$this->serviceUsageUnitId=$serviceUsageUnitId;
		return $this;
	}

	/**
	 * get value for service_usageunitid 
	 *
	 * type:INT,size:10,default:null,primary,unique,autoincrement
	 *
	 * @return mixed
	 */
	public function getServiceUsageUnitId() {
		return $this->serviceUsageUnitId;
	}
	...
	public function toArray() {
		return array(
			self::FIELD_SERVICE_USAGEUNITID=>$this->getServiceUsageUnitId(),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerServiceUsageUnit instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerServiceUsageUnit $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerServiceUsageUnit[]
	 */
	public static function findByExample(PDO $db,VTigerServiceUsageUnit $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerServiceUsageUnit instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_service_usageunit`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerServiceUsageUnit instances
	 *
	...
	/**
	 * returns the result as an array of VTigerServiceUsageUnit instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerServiceUsageUnit[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerServiceUsageUnit instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_service_usageunit`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function assignByHash($result) {
		$this->setServiceUsageUnitId($result['service_usageunitid']);
	 ...
	 * @return VTigerServiceUsageUnit
	 */
	public static function findById(PDO $db,$serviceUsageUnitId) {
		$stmt=self::prepareStatement($db,self::SQL_SELECT_PK);
		$stmt->bindValue(1,$serviceUsageUnitId);
		$affected=$stmt->execute();
		if (false===$affected) {
			$stmt->closeCursor();
			throw new Exception($stmt->errorCode() . ':' . var_export($stmt->errorInfo(), true), 0);
	...
	protected function bindValues(PDOStatement &$stmt) {
		$stmt->bindValue(1,$this->getServiceUsageUnitId());
		$stmt->bindValue(2,$this->getServiceUsageUnit());
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getServiceUsageUnitId()) {
			$stmt=self::prepareStatement($db,self::SQL_INSERT_AUTOINCREMENT);
			$stmt->bindValue(1,$this->getServiceUsageUnit());
		...
		if (false!==$lastInsertId) {
			$this->setServiceUsageUnitId($lastInsertId);
		}
		$stmt->closeCursor();
		$this->notifyPristine();
		return $affected;
	...
	public function updateToDatabase(PDO $db) {
		...
		$this->bindValues($stmt);
		$stmt->bindValue(5,$this->getServiceUsageUnitId());
		$affected=$stmt->execute();
		if (false===$affected) {
			$stmt->closeCursor();
			throw new Exception($stmt->errorCode() . ':' . var_export($stmt->errorInfo(), true), 0);
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerServiceUsageUnit';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerServiceUsageUnit');
	}

	/**
	 * get single VTigerServiceUsageUnit instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerServiceUsageUnit from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerServiceUsageUnit') as $node) {
