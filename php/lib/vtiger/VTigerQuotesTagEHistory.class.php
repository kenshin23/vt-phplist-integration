 ...
 * @package entity
 */
class VTigerQuotesTagEHistory extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerQuotesTagEHistory';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_quotestagehistory';
	const SQL_INSERT='INSERT INTO `vtiger_quotestagehistory` (`historyid`,`quoteid`,`accountname`,`total`,`quotestage`,`lastmodified`) VALUES (?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_quotestagehistory` (`quoteid`,`accountname`,`total`,`quotestage`,`lastmodified`) VALUES (?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_quotestagehistory` SET `historyid`=?,`quoteid`=?,`accountname`=?,`total`=?,`quotestage`=?,`lastmodified`=? WHERE `historyid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_quotestagehistory` WHERE `historyid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_quotestagehistory` WHERE `historyid`=?';
	const FIELD_HISTORYID=607522013;
	const FIELD_QUOTEID=774946885;
	const FIELD_ACCOUNTNAME=227394278;
	const FIELD_TOTAL=-564194702;
	const FIELD_QUOTESTAGE=1003243412;
	const FIELD_LASTMODIFIED=-751069071;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerQuotesTagEHistory instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerQuotesTagEHistory $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerQuotesTagEHistory[]
	 */
	public static function findByExample(PDO $db,VTigerQuotesTagEHistory $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerQuotesTagEHistory instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_quotestagehistory`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerQuotesTagEHistory instances
	 *
	...
	/**
	 * returns the result as an array of VTigerQuotesTagEHistory instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerQuotesTagEHistory[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerQuotesTagEHistory instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_quotestagehistory`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(2,$this->getQuoteId());
		$stmt->bindValue(3,$this->getAccountName());
		$stmt->bindValue(4,$this->getTotal());
		$stmt->bindValue(5,$this->getQuotesTagE());
	...
	/**
	 * Fetch VTigerQuotes which references this VTigerQuotesTagEHistory. Will return null in case reference is invalid.
	 * `vtiger_quotestagehistory`.`quoteid` -> `vtiger_quotes`.`quoteid`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return VTigerQuotes
	...
	public function fetchVTigerQuotes(PDO $db, $sort=null) {
		$filter=array(VTigerQuotes::FIELD_QUOTEID=>$this->getQuoteId());
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='VTigerQuotesTagEHistory';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerQuotesTagEHistory');
	}

	/**
	 * get single VTigerQuotesTagEHistory instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerQuotesTagEHistory from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerQuotesTagEHistory') as $node) {
