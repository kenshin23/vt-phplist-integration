 ...
 * @package entity
 */
class VTigerHomeLayout extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerHomeLayout';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_home_layout';
	const SQL_INSERT='INSERT INTO `vtiger_home_layout` (`userid`,`layout`) VALUES (?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_home_layout` (`userid`,`layout`) VALUES (?,?)';
	const SQL_UPDATE='UPDATE `vtiger_home_layout` SET `userid`=?,`layout`=? WHERE `userid`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_home_layout` WHERE `userid`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_home_layout` WHERE `userid`=?';
	const FIELD_USERID=1023931392;
	const FIELD_LAYOUT=750238980;
	...
	private static $PROPERTY_TYPES=array(
		...
		self::FIELD_LAYOUT=>Db2PhpEntity::PHP_TYPE_INT);
	private static $FIELD_TYPES=array(
		self::FIELD_USERID=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false),
		self::FIELD_LAYOUT=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,false));
	...
	/**
	 * set value for layout 
	 *
	 * type:INT,size:10,default:4
	 *
	 * @param mixed $layout
	 * @return VTigerHomeLayout
	 */
	public function &setLayout($layout) {
		$this->notifyChanged(self::FIELD_LAYOUT,$this->layout,$layout);
		$this->layout=$layout;
		return $this;
	}
	...
	public function toArray() {
		return array(
			...
			self::FIELD_LAYOUT=>$this->getLayout());
	}
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerHomeLayout instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerHomeLayout $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerHomeLayout[]
	 */
	public static function findByExample(PDO $db,VTigerHomeLayout $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerHomeLayout instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `vtiger_home_layout`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerHomeLayout instances
	 *
	...
	/**
	 * returns the result as an array of VTigerHomeLayout instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerHomeLayout[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerHomeLayout instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `vtiger_home_layout`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(2,$this->getLayout());
	}
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerHomeLayout');
	}

	/**
	 * get single VTigerHomeLayout instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerHomeLayout from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerHomeLayout') as $node) {
