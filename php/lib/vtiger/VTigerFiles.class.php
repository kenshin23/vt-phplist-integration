 ...
 * @package entity
 */
class VTigerFiles extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='VTigerFiles';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='vtiger_files';
	const SQL_INSERT='INSERT INTO `vtiger_files` (`id`,`name`,`content`,`deleted`,`date_entered`,`assigned_user_id`) VALUES (?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `vtiger_files` (`id`,`name`,`content`,`deleted`,`date_entered`,`assigned_user_id`) VALUES (?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `vtiger_files` SET `id`=?,`name`=?,`content`=?,`deleted`=?,`date_entered`=?,`assigned_user_id`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `vtiger_files` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `vtiger_files` WHERE `id`=?';
	const FIELD_ID=274954600;
	const FIELD_NAME=-2056452200;
	const FIELD_CONTENT=-1124306868;
	const FIELD_DELETED=-525374484;
	const FIELD_DATE_ENTERED=1054209523;
	const FIELD_ASSIGNED_USER_ID=-1050126805;
	...
	private static $FIELD_TYPES=array(
		self::FIELD_ID=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,36,0,false),
		self::FIELD_NAME=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,36,0,true),
	 ...
	 * set value for id 
	 *
	 * type:VARCHAR,size:36,default:null,primary,unique
	 *
	 * @param mixed $id
	 * @return VTigerFiles
	 */
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of VTigerFiles instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param VTigerFiles $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return VTigerFiles[]
	 */
	public static function findByExample(PDO $db,VTigerFiles $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of VTigerFiles instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of VTigerFiles instances
	 *
	...
	/**
	 * returns the result as an array of VTigerFiles instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return VTigerFiles[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of VTigerFiles instances.
	 *
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(5,$this->getDateEntered());
		$stmt->bindValue(6,$this->getAssignedUserId());
	}
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'VTigerFiles');
	}

	/**
	 * get single VTigerFiles instance from a DOMElement
	 *
	...
	/**
	 * get all instances of VTigerFiles from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('VTigerFiles') as $node) {
