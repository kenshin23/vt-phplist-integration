 ...
 * @package entity
 */
class PhPListUserAttribute extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PhPListUserAttribute';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='phplist_user_attribute';
	const SQL_INSERT='INSERT INTO `phplist_user_attribute` (`id`,`name`,`type`,`listorder`,`default_value`,`required`,`tablename`) VALUES (?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `phplist_user_attribute` (`name`,`type`,`listorder`,`default_value`,`required`,`tablename`) VALUES (?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `phplist_user_attribute` SET `id`=?,`name`=?,`type`=?,`listorder`=?,`default_value`=?,`required`=?,`tablename`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `phplist_user_attribute` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `phplist_user_attribute` WHERE `id`=?';
	const FIELD_ID=1210953656;
	const FIELD_NAME=-209524248;
	const FIELD_TYPE=-209322345;
	const FIELD_LISTORDER=-2036650957;
	const FIELD_DEFAULT_VALUE=988077878;
	const FIELD_REQUIRED=-1112562564;
	const FIELD_TABLENAME=1479918108;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PhPListUserAttribute instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PhPListUserAttribute $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PhPListUserAttribute[]
	 */
	public static function findByExample(PDO $db,PhPListUserAttribute $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PhPListUserAttribute instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `phplist_user_attribute`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of PhPListUserAttribute instances
	 *
	...
	/**
	 * returns the result as an array of PhPListUserAttribute instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PhPListUserAttribute[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PhPListUserAttribute instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `phplist_user_attribute`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='PhPListUserAttribute';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PhPListUserAttribute');
	}

	/**
	 * get single PhPListUserAttribute instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PhPListUserAttribute from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PhPListUserAttribute') as $node) {
