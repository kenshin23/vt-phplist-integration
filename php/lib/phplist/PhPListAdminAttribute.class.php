 ...
 * @package entity
 */
class PhPListAdminAttribute extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PhPListAdminAttribute';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='phplist_adminattribute';
	const SQL_INSERT='INSERT INTO `phplist_adminattribute` (`id`,`name`,`type`,`listorder`,`default_value`,`required`,`tablename`) VALUES (?,?,?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `phplist_adminattribute` (`name`,`type`,`listorder`,`default_value`,`required`,`tablename`) VALUES (?,?,?,?,?,?)';
	const SQL_UPDATE='UPDATE `phplist_adminattribute` SET `id`=?,`name`=?,`type`=?,`listorder`=?,`default_value`=?,`required`=?,`tablename`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `phplist_adminattribute` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `phplist_adminattribute` WHERE `id`=?';
	const FIELD_ID=-1692863341;
	const FIELD_NAME=951084035;
	const FIELD_TYPE=951285938;
	const FIELD_LISTORDER=-757282056;
	const FIELD_DEFAULT_VALUE=1006605179;
	const FIELD_REQUIRED=1561106711;
	const FIELD_TABLENAME=-1535680287;
	...
	private static $PROPERTY_NAMES=array(
		...
		self::FIELD_TYPE=>'type',
		self::FIELD_LISTORDER=>'listOrder',
		self::FIELD_DEFAULT_VALUE=>'defaultValue',
		self::FIELD_REQUIRED=>'required',
		self::FIELD_TABLENAME=>'tableName');
	private static $PROPERTY_TYPES=array(
		...
		self::FIELD_DEFAULT_VALUE=>Db2PhpEntity::PHP_TYPE_STRING,
	...
	private static $FIELD_TYPES=array(
		...
		self::FIELD_TYPE=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,30,0,true),
		self::FIELD_LISTORDER=>array(Db2PhpEntity::JDBC_TYPE_INTEGER,10,0,true),
		self::FIELD_DEFAULT_VALUE=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,255,0,true),
		self::FIELD_REQUIRED=>array(Db2PhpEntity::JDBC_TYPE_TINYINT,3,0,true),
		self::FIELD_TABLENAME=>array(Db2PhpEntity::JDBC_TYPE_VARCHAR,255,0,true));
	private static $DEFAULT_VALUES=array(
		self::FIELD_ID=>null,
		self::FIELD_NAME=>'',
		self::FIELD_TYPE=>null,
		self::FIELD_LISTORDER=>null,
		self::FIELD_DEFAULT_VALUE=>null,
		self::FIELD_REQUIRED=>null,
		self::FIELD_TABLENAME=>null);
	private $id;
	private $name;
	private $type;
	private $listOrder;
	...
	public function &setDefaultValue($defaultValue) {
		$this->notifyChanged(self::FIELD_DEFAULT_VALUE,$this->defaultValue,$defaultValue);
		$this->defaultValue=$defaultValue;
		return $this;
	}

	/**
	 * get value for default_value 
	 *
	 * type:VARCHAR,size:255,default:null,nullable
	 *
	 * @return mixed
	...
	public function toArray() {
		return array(
			...
			self::FIELD_DEFAULT_VALUE=>$this->getDefaultValue(),
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PhPListAdminAttribute instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PhPListAdminAttribute $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PhPListAdminAttribute[]
	 */
	public static function findByExample(PDO $db,PhPListAdminAttribute $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PhPListAdminAttribute instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `phplist_adminattribute`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of PhPListAdminAttribute instances
	 *
	...
	/**
	 * returns the result as an array of PhPListAdminAttribute instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PhPListAdminAttribute[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PhPListAdminAttribute instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `phplist_adminattribute`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function assignByHash($result) {
		...
		$this->setDefaultValue($result['default_value']);
	...
	protected function bindValues(PDOStatement &$stmt) {
		...
		$stmt->bindValue(7,$this->getTableName());
	}
	...
	public function insertIntoDatabase(PDO $db) {
		if (null===$this->getId()) {
			...
			$stmt->bindValue(6,$this->getTableName());
		} else {
	...
	public static function toEzcPersistentObjectDefinition() {
		...
		$def->class='PhPListAdminAttribute';
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PhPListAdminAttribute');
	}

	/**
	 * get single PhPListAdminAttribute instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PhPListAdminAttribute from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PhPListAdminAttribute') as $node) {
