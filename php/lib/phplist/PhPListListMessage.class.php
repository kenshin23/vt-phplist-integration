 ...
 * @package entity
 */
class PhPListListMessage extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='PhPListListMessage';
	const SQL_IDENTIFIER_QUOTE='`';
	const SQL_TABLE_NAME='phplist_listmessage';
	const SQL_INSERT='INSERT INTO `phplist_listmessage` (`id`,`messageid`,`listid`,`entered`,`modified`) VALUES (?,?,?,?,?)';
	const SQL_INSERT_AUTOINCREMENT='INSERT INTO `phplist_listmessage` (`messageid`,`listid`,`entered`,`modified`) VALUES (?,?,?,?)';
	const SQL_UPDATE='UPDATE `phplist_listmessage` SET `id`=?,`messageid`=?,`listid`=?,`entered`=?,`modified`=? WHERE `id`=?';
	const SQL_SELECT_PK='SELECT * FROM `phplist_listmessage` WHERE `id`=?';
	const SQL_DELETE_PK='DELETE FROM `phplist_listmessage` WHERE `id`=?';
	const FIELD_ID=586400969;
	const FIELD_MESSAGEID=1912082420;
	const FIELD_LISTID=1276985063;
	const FIELD_ENTERED=-842095991;
	const FIELD_MODIFIED=1155186679;
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of PhPListListMessage instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param PhPListListMessage $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return PhPListListMessage[]
	 */
	public static function findByExample(PDO $db,PhPListListMessage $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of PhPListListMessage instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	public static function findByFilter(PDO $db, $filter, $and=true, $sort=null) {
		...
		$sql='SELECT * FROM `phplist_listmessage`'
	...
	/**
	 * Will execute the passed statement and return the result as an array of PhPListListMessage instances
	 *
	...
	/**
	 * returns the result as an array of PhPListListMessage instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return PhPListListMessage[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of PhPListListMessage instances.
	 *
	...
	public static function deleteByFilter(PDO $db, $filter, $and=true) {
		...
		$sql='DELETE FROM `phplist_listmessage`'
		. self::buildSqlWhere($filter, $and, false, true);
		$stmt=self::prepareStatement($db, $sql);
		self::bindValuesForFilter($stmt, $filter);
		$affected=$stmt->execute();
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'PhPListListMessage');
	}

	/**
	 * get single PhPListListMessage instance from a DOMElement
	 *
	...
	/**
	 * get all instances of PhPListListMessage from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('PhPListListMessage') as $node) {
